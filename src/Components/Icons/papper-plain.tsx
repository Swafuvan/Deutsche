...
const PapperPlain = (props: SVGProps<SVGSVGElement>, _ref: Ref<SVGSVGElement>) => (
  <svg
    width="70"
    height="70"
    viewBox="0 0 70 70"
  ...
  >
    <circle cx="35" cy="35" r="35" fill="url(#paint0_linear_38_109)" />
    <path
...
const ForwardRef = forwardRef(PapperPlain);
